...
-----------------------------------------------------------]]
include( 'modules/fonts/cl_init.lua' )
include( 'shared.lua' )
...
include( 'modules/vehicle_shop/cl_init.lua' )
include( 'modules/vehicle_spawn/cl_init.lua' )
include( 'modules/properties/cl_init.lua' )
include( 'modules/inventory/cl_init.lua' )
include( 'modules/hud/cl_init.lua' )
include( 'modules/weed/cl_init.lua' )
...
-- Tell server client has initialized, keep in main cl_init
hook.Add( "InitPostEntity", "Ready", function()
	Properties = {}
	net.Start( "clientInitialize" )
	net.SendToServer()
end )
